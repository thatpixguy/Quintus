...
var Quintus = function Quintus(opts) {
  ...
  */
  ...
  Q.setup = function(id, options) {
    ...
    else if(options.maximize && options.width && options.height) {
        var displayAspect = w/h;
        var optionAspect = options.width/options.height;

        var scale;

        if(displayAspect>optionAspect) {
         //screen is wider
         scale = options.height / h; 
        } else {
         scale = options.width / w;
        }

        Q.el.style.height = options.height / scale + "px";
        Q.el.style.width = options.width / scale + "px";
        Q.el.width = options.width;
        Q.el.height = options.height;
    } else {
      Q.el.style.height = h + "px";
      Q.el.style.width = w + "px";
      Q.el.width = w;
    ...
    Q.cssWidth = parseInt(Q.el.style.width,10);
    Q.cssHeight = parseInt(Q.el.style.height,10);
